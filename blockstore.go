...
// WithoutDatastore returns a FileManager/Filestore backed entirely by a
...
func WithoutDatastore(bs blockstore.Blockstore) (blockstore.Blockstore, error) {
